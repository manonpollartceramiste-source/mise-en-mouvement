          ...
          <table className="w-full text-sm">
            <thead>
              <tr className="border-b border-taupe-300/30 bg-sand-50">
                ...
                <th className="hidden px-5 py-3.5 text-left text-xs font-medium uppercase tracking-wider text-taupe-500 sm:table-cell">
                  Échéance
                </th>
            ...
            <tbody className="divide-y divide-taupe-300/20">
              {invoices.map((inv) => (
                <tr key={inv.id} className="transition-colors hover:bg-sand-50/50">
                  ...
                  <td className="hidden px-5 py-4 text-taupe-600 sm:table-cell">
                  ...
                  <td className="px-5 py-4">
                    <span
                      className={`inline-block rounded-full px-2.5 py-0.5 text-xs font-medium ${INVOICE_STATUS_COLORS[inv.status]}`}
                    >
